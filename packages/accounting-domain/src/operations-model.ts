...
export interface OperationalInvoice { readonly id: string; readonly attemptId: string; readonly sourceTemplateInvoiceId?: string; readonly customerId: string; readonly number: string; readonly invoiceDate: string; readonly dueDate: string; readonly status: InvoiceStatus; readonly arAccountId: string; readonly lineItems: readonly InvoiceLineItem[]; readonly journalEntryId: string }
export interface CustomerPayment { readonly id: string; readonly attemptId: string; readonly sourceTemplatePaymentId?: string; readonly customerId: string; readonly paymentDate: string; readonly amountCents: number; readonly destinationAccountId: string; readonly method?: string; readonly reference?: string; readonly journalEntryId: string }
